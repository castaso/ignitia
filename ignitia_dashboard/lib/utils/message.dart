class Messages{
  ...
  static const errorShiftNameEmpty = "Shift name can not be empty";
  static const errorShiftTimeRange = "End time can not be before start time";
  static const errorShiftDateRange = "End date can not be before start date";
  static const errorShiftSelectionEmpty = "Please select a shift";
  static const errorEmployeeSelectionEmpty = "Please select at least one employee";
  static const successShiftDelete = "Shift has been deleted successfully";
  static const successShiftAssign = "Shift has been assigned successfully";
}