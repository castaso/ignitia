...
class AddOfficeLocationPage extends StatefulWidget {
  const AddOfficeLocationPage({Key? key}) : super(key: key);

  @override
  State<AddOfficeLocationPage> createState() => _AddOfficeLocationPageState();
}

class _AddOfficeLocationPageState extends State<AddOfficeLocationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: CustomAppBar(
          title: Strings.titleAddOfficeLocationPage,
        ),
        body: Stack(
          children: [
            Padding(
