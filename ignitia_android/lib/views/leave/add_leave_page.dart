...
class AddLeavePage extends StatefulWidget {
  ...
  const AddLeavePage({Key? key, required this.userLeaveModel})
      : super(key: key);

  @override
  State<AddLeavePage> createState() =>
      _AddLeavePageState(this.userLeaveModel);
}
...
class _AddLeavePageState extends State<AddLeavePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: CustomAppBar(
          title: Strings.titleAddLeavePage,
        ),
        body: Stack(
          children: [
            Padding(
                        ...
                        children: [
                          ...
                          CustomButton(
                            onTap: () async {
                              ...
                              var isSuccess = await viewModel.addUserLeave(userLeaveModel);
                              if (isSuccess) {
